...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_SR_PLT_1, SQUAD_SR_PLT_2, SQUAD_SR_PLT_3, SQUAD_SR_PLT_4))
